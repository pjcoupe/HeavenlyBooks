...
namespace Anima2D 
{
	public abstract class Ik2D : MonoBehaviour
	{
		...
		[SerializeField]
		Transform m_AlternateSourceTransform;

		[SerializeField] float m_AlternateSourceWeight = 0f;
		...
		public Transform alternateSourceTransform
		{
			get { return m_AlternateSourceTransform; }
			set { m_AlternateSourceTransform = value; }
		}

		public float alternateSourceWeight
		{
			get { return m_AlternateSourceWeight; }
			set { m_AlternateSourceWeight = value; }
		}
		public float weight
		{
			get { return m_Weight; }
		...
		protected virtual void OnIkUpdate()
		{
			...
			Vector3 thisOrAlternateSourcePosition = transform.position;
			if (alternateSourceTransform != null && alternateSourceWeight > 0){
				thisOrAlternateSourcePosition = Vector3.Lerp(thisOrAlternateSourcePosition, alternateSourceTransform.position, alternateSourceWeight);
			}
			solver.targetPosition = thisOrAlternateSourcePosition;
